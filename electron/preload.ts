...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  sub2ApiStartDependencies: (payload: Sub2ApiDesktopSetupProfile, config?: Partial<Sub2ApiDesktopRuntimeConfig>, managedConfig?: Partial<Sub2ApiDesktopManagedConfig>) => ipcRenderer.invoke('sub2api:startDependencies', payload, config, managedConfig),
  sub2ApiStopDependencies: (config?: Partial<Sub2ApiDesktopRuntimeConfig>, managedConfig?: Partial<Sub2ApiDesktopManagedConfig>) => ipcRenderer.invoke('sub2api:stopDependencies', config, managedConfig),
