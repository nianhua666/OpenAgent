...
<template>
  <svg style="display:none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <!-- 账号类型 -->
      <symbol id="icon-types" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <!-- 记录 -->
      <symbol id="icon-records" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <symbol id="icon-settings" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <path d="M12 1v2m0 18v2m-9-11h2m18 0h2m-3.64-6.36l-1.42 1.42M6.06 17.94l-1.42 1.42m0-14.72l1.42 1.42m11.88 11.88l1.42 1.42"/>
      </symbol>

      <!-- 数据管理 -->
      <symbol id="icon-data" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <!-- 最小化 -->
      <symbol id="icon-minimize" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round">
      ...
      <symbol id="icon-restore" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <path d="M6 9h-1a2 2 0 01-2-2V6a2 2 0 012-2h1"/>
      </symbol>
      ...
      <symbol id="icon-keyboard" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <path d="M6 9h.01M10 9h.01M14 9h.01M18 9h.01M5 13h.01M9 13h.01M13 13h.01M17 13h.01"/>
        <path d="M8 16h8"/>
      </symbol>
